...
require_once POPUPPILOT_PATH . 'includes/api/class-ai-proxy.php';
...
require_once POPUPPILOT_PATH . 'includes/integrations/class-mailchimp.php';
require_once POPUPPILOT_PATH . 'includes/integrations/class-hubspot.php';
require_once POPUPPILOT_PATH . 'includes/integrations/class-convertkit.php';
require_once POPUPPILOT_PATH . 'includes/integrations/class-webhooks.php';
